...
/**
 * 
 * This class implements the "Mutator2" heuristic. It implements the Heuristic interface for abstraction.
 * "Mutation2" flips 1/4 of the vertices included in the solution clique.
 *
 */
public class Mutator2 implements Heuristic
{
	...
	public int[] mutate(int[] solution, int[][] adjMatrix, ObjectiveFunctionMWCP evaluator) 
	{
        ...
        //Calculate the number of vertices to remove from the clique (25% of the current clique size)
        int numVerticesToRemove = (int) Math.ceil(verticesInClique.size() / 4.0);
