...
/**
 * 
 * This class implements the "Mutator3" heuristic. It implements the Heuristic interface for abstraction.
 * "Mutation3" flips 1/2 of the vertices included in the solution clique.
 *
 */
public class Mutator3 implements Heuristic
{
	...
	public int[] mutate(int[] solution, int[][] adjMatrix, ObjectiveFunctionMWCP evaluator) 
	{
        ...
        //Calculate the number of vertices to remove from the clique (50% of the current clique size)
        int numVerticesToRemove = (int) Math.ceil(verticesInClique.size() / 2.0);
